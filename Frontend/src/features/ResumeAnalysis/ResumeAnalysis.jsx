...
export default function ResumeAnalysis() {
    ...
    const handleGenerateResume = async () => {
        try {
            ...
            // Uses your custom 'api' instance. 
            // responseType: 'blob' is strictly required for Axios to handle PDFs properly.
            ...
            link.href = url;
            link.download = `Optimized_Resume_${id}.pdf`;
            ...
            alert("Something went wrong while generating your premium resume.");
        } finally {
    ...
    return (
        <main className="relative min-h-screen bg-[#030308] text-slate-200 antialiased pb-24 selection:bg-indigo-500/30 selection:text-white overflow-x-hidden">
            ...
            <div className="mx-auto max-w-7xl px-4 pt-24 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="animate-fade-up flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between mb-10">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4">
                        ...
                        {/* AI Stats Badges - Added select-none and cursor-default so they don't feel interactive */}
                        ...
                        {/* Export Button - Fixed disabled scaling and hover effects */}
                        <button
            ...
            ${isGeneratingPdf
                                    ? "cursor-not-allowed opacity-60 border-indigo-500/10 bg-indigo-500/5" // Removed active:scale-95 here
                                    : "cursor-pointer bg-indigo-500/10 border-indigo-500/30 hover:bg-indigo-500/20 hover:border-indigo-400 hover:shadow-[0_0_20px_rgba(99,102,241,0.2)] active:scale-95" // Added active:scale-95 ONLY when enabled
                                }`}
                        >
