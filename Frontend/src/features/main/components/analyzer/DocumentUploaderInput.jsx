...
export default function DocumentUploaderInput({ title, description, placeholder, value, setValue, file, setFile, onError }) {
                            ...
                            >
                                <div
                                    onClick={(e) => {
                                        e.stopPropagation();
                                        if (!isDesktop) {
                                            if (onError) onError("Preview is available on desktop only.");
                                            return;
                                        }
                                        setShowPreview(true);
                                    }}
                                ...
                                {isClosing ? (
                                    <span className="flex items-center gap-2 text-white">
                                        <svg className="h-4 w-4 animate-spin" viewBox="0 0 24 24" fill="none">
                                            ...
                                            <path className="opacity-100" fill="currentColor" d="M22 12a10 10 0 0 1-10 10V18a6 6 0 0 0 6-6h4Z" />
                                        </svg>
                                        Closing...
                                    </span>
                                ) : (
